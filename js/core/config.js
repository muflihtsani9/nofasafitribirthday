  ...
  timeline: [
    {
      date: "the beginning",
      title: "Satu Tatapan",
      quote: "semua berawal dari satu tatapan, di antara ribuan wajah yang berlalu, entah mengapa mataku memilihmu",
      icon: "✦",
    },
    {
      date: "first words",
      title: "Tiga Kata",
      quote: "tiga kata yang kamu ucapkan yaitu i love you, entah bagaimana, bisa mengubah struktur hidupku tanpa kusadari",
      icon: "◈",
    },
    {
      date: "first voice",
      title: "Suaramu",
      quote: "pertama kali mendengar suaramu, dunia seakan melambat sejenak— memberiku waktu untuk menyadari bahwa ada suara yang mampu membuat hati ini merasa pulang",
      icon: "✧",
    },
    {
      date: "right now",
      title: "Hari Ini",
      quote: "hari ini, aku masih memilihmu, seperti kemarin dan seperti hari-hari yang akan datang.",
      icon: "♡",
    },
  ],
